                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-4">
                        <div class="hero hero-bg-image hero-bg-parallax text-white"
                            style="background-image: url('{{ asset('admin/img/unsplash/andre-benz-1214056-unsplash.jpg') }}');">
                            <div class="hero-inner">
                                <h2>Welcome, Ujang!</h2>
                                <p class="lead">You almost arrived, complete the information about your account to
                                    complete registration.</p>
                    ...
                    <div class="col-12 mb-4">
                        <div class="hero hero-bg-image text-white"
                            style="background-image: url('{{ asset('admin/img/unsplash/eberhard-grossgasteiger-1207565-unsplash.jpg') }}');">
                            <div class="hero-inner">
                                <h2>Welcome, Ujang!</h2>
                                <p class="lead">You almost arrived, complete the information about your account to
                                    complete registration.</p>
