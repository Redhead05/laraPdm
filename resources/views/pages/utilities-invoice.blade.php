                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row mt-4">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="images">
                                            <img src="{{ asset('admin/img/payment/visa.png') }}"
                                                alt="visa">
                                            <img src="{{ asset('admin/img/payment/jcb.png') }}"
                                                alt="jcb">
                                            <img src="{{ asset('admin/img/payment/mastercard.png') }}"
                                                alt="mastercard">
                                            <img src="{{ asset('admin/img/payment/paypal.png') }}"
                                                alt="paypal">
                                        </div>
                                    </div>
