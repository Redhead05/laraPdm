                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="owl-carousel owl-theme slider"
                                    id="slider1">
                                    <div><img alt="image"
                                            src="{{ asset('admin/img/news/img01.jpg') }}"></div>
                                    <div><img alt="image"
                                            src="{{ asset('admin/img/news/img08.jpg') }}"></div>
                                    <div><img alt="image"
                                            src="{{ asset('admin/img/news/img10.jpg') }}"></div>
                                    <div><img alt="image"
                                            src="{{ asset('admin/img/news/img09.jpg') }}"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="owl-carousel owl-theme slider"
                                    id="slider2">
                                    <div><img alt="image"
                                            src="{{ asset('admin/img/news/img01.jpg') }}">
                                    ...
                                    <div><img alt="image"
                                            src="{{ asset('admin/img/news/img08.jpg') }}">
                                        <div class="slider-caption">
                                    ...
                                    <div><img alt="image"
                                            src="{{ asset('admin/img/news/img10.jpg') }}">
                                        <div class="slider-caption">
                                    ...
                                    <div><img alt="image"
                                            src="{{ asset('admin/img/news/img09.jpg') }}">
                                        <div class="slider-caption">
...
@push('scripts')
    ...
    <script src="{{ asset('admin/js/page/modules-slider.js') }}"></script>
@endpush
