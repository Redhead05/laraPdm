...
@push('style')
    <!-- CSS Libraries -->
    <link rel="stylesheet"
        href="{{ asset('admin/library/izitoast/dist/css/iziToast.min.css') }}">
    <link rel="stylesheet"
...
@push('scripts')
    <!-- JS Libraies -->
    <script src="{{ asset('admin/library/izitoast/dist/js/iziToast.js') }}"></script>
    ...
    <script src="{{ asset('admin/library/jqvmap/dist/maps/jquery.vmap.indonesia.js') }}"></script>

    <!-- Page Specific JS File -->
    <script src="{{ asset('admin/js/page/modules-vector-map.js') }}"></script>
@endpush
