                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                ...
                                                <figure class="imagecheck-figure">
                                                    <img src="{{ asset('admin/img/news/img01.jpg') }}"
                                                        alt="}"
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                <input name="imagecheck"
                                                    ...
                                                    checked />
                                                <figure class="imagecheck-figure">
                                                    <img src="{{ asset('admin/img/news/img02.jpg') }}"
                                                        alt="}"
                                                        class="imagecheck-image">
                                                </figure>
                                            </label>
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                <input name="imagecheck"
                                                    ...
                                                    class="imagecheck-input" />
                                                <figure class="imagecheck-figure">
                                                    <img src="{{ asset('admin/img/news/img03.jpg') }}"
                                                        alt="}"
                                                        class="imagecheck-image">
                                                </figure>
                                            </label>
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                <input name="imagecheck"
                                                    ...
                                                    checked />
                                                <figure class="imagecheck-figure">
                                                    <img src="{{ asset('admin/img/news/img04.jpg') }}"
                                                        alt="}"
                                                        class="imagecheck-image">
                                                </figure>
                                            </label>
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                <input name="imagecheck"
                                                    ...
                                                    class="imagecheck-input" />
                                                <figure class="imagecheck-figure">
                                                    <img src="{{ asset('admin/img/news/img05.jpg') }}"
                                                        alt="}"
                                                        class="imagecheck-image">
                                                </figure>
                                            </label>
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                <input name="imagecheck"
                                                    ...
                                                    class="imagecheck-input" />
                                                <figure class="imagecheck-figure">
                                                    <img src="{{ asset('admin/img/news/img06.jpg') }}"
                                                        alt="}"
                                                        class="imagecheck-image">
                                                </figure>
                                            </label>
