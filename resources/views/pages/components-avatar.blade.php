                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <figure class="avatar avatar-xl mr-2">
                                    <img src="{{ asset('admin/img/avatar/avatar-1.png') }}"
                                        alt="...">
                                </figure>
                                <figure class="avatar avatar-lg mr-2">
                                    <img src="{{ asset('admin/img/avatar/avatar-2.png') }}"
                                        alt="...">
                                </figure>
                                ...
                                <figure class="avatar avatar-sm mr-2">
                                    <img src="{{ asset('admin/img/avatar/avatar-3.png') }}"
                                        alt="...">
                                </figure>
                                <figure class="avatar avatar-xs mr-2">
                                    <img src="{{ asset('admin/img/avatar/avatar-4.png') }}"
                                        alt="...">
                                </figure>
                            </div>
                        </div>
